export const epmCapabilities = [
  ...
  {
    title: "Cloud-Based EPM",
    description:
      "Access your EPM solutions securely from anywhere. Scale effortlessly and benefit from the latest innovations in cloud technology.",
  ...
  },
  {
    ...
    description:
      "Our experienced consultants guide you through every step of your EPM journey, from strategy to implementation and beyond.",
