...
export default function OptimizedImage({
  ...
  useEffect(() => {
    ...
    if (src.startsWith("/images/") && !src.includes("/optimized/")) {
      ...
      // This logic works for ANY folder structure under /images/:
      // - /images/logo.png -> /images/optimized/logo.webp
      // - /images/blogs/1.jpg -> /images/optimized/blogs/1.webp
      // - /images/clients/services/solution.jpg -> /images/optimized/clients/services/solution.webp
